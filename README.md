...
- применение компонента ErrorBoundary
...
>
- Работа с Redux actions и Redux reducers осуществляется при помощи библиотеки Redux Actions
- Пример классической обработки reducers можно увидеть в компонентах с использованием хука useReducer
>
- Взаимодействие с серверной частью, обработку данных и статусов (data, isLoading, isError) при помощи Redux и Redux Thunk можно увидеть на примере формы логина (modules/user)
...
Также хотел отметить, что не все из использованного я бы стал применять в реальном проекте.
