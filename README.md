...
- Работа с actions и reducers Redux store осуществляется при помощи библиотеки Redux Actions
...
- В компонентах PlacesContent и PageMainWrapperOffers применяется React context
- В других частях приложения, где необходима передача данных к потомкам в различных ветках, используется Redux
