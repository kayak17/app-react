...
Деплой версия проекта: https://kayak17.github.io/  
Production код и ридми деплой версии проекта: https://github.com/kayak17/kayak17.github.io  
...
- Работа с Redux actions и Redux reducers осуществляется при помощи библиотеки Redux Actions (кроме modules/favorites)
- Для modules/favorites работа с Redux actions и Redux reducers осуществляется классическим способом работы с Redux
>
- Взаимодействие с серверной частью, обработку данных и статусов (data, isLoading, isError) при помощи Redux и Redux Thunk можно увидеть на примере формы логина и страницы с избранными предложениями (modules/user и modules/favorites)
- В других компонентах приложения для обработки данных и статусов используются кастомные хуки useFetch и useFetchCached

В реальном и более крупном проекте я бы еще добавил асинхронную загрузку модулей Redux, чтобы при запуске приложения загружался не весь код папки modules, а только необходимые разделы
