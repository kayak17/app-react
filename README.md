...
Для демонстрационных целей в приложении применены несколько схожих подходов  
Подробнее ниже в разделе "Применение схожих технологий"

![Экран главной страницы](/my-app-main.jpg)
...
4. Параллельно в другом терминале запустить приложение локально (1337 порт)
...
>
- Взаимодействие с серверной частью, обработку данных и статусов (data, isLoading, isError) при помощи Redux и Redux Thunk можно увидеть на примере формы логина
